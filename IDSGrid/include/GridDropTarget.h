...
/////////////////////////////////////////////////////////////////////////////
// CIDSGridDropTarget command target

class CIDSGridDropTarget : public COleDropTarget
{
public:
    CIDSGridDropTarget();
    virtual ~CIDSGridDropTarget();
...
// Operations
public:
    BOOL Register(CIDSGridCtrl *pGridCtrl);
    virtual void Revoke();
...
// Overrides
    ...
    //{{AFX_VIRTUAL(CIDSGridDropTarget)
    //}}AFX_VIRTUAL
