...
// CIDSInPlaceEdit from http://www.codeguru.com/listview/edit_subitems.shtml
//
...
//
// For use with CXTPGridCtrl v2.10+
//
// History:
...
CIDSInPlaceEdit::CIDSInPlaceEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
CIDSInPlaceEdit::~CIDSInPlaceEdit()
{
}

BEGIN_MESSAGE_MAP(CIDSInPlaceEdit, CEdit)
    //{{AFX_MSG_MAP(CIDSInPlaceEdit)
    ON_WM_KILLFOCUS()
    ON_WM_CHAR()
    ON_WM_KEYDOWN()
    ON_WM_GETDLGCODE()
...
////////////////////////////////////////////////////////////////////////////
// CIDSInPlaceEdit message handlers

// If an arrow key (or associated) is pressed, then exit if
//  a) The Ctrl key was down, or
//  b) m_bExitOnArrows == TRUE
void CIDSInPlaceEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CIDSInPlaceEdit::OnKillFocus(CWnd* pNewWnd)
{
    CEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

void CIDSInPlaceEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
UINT CIDSInPlaceEdit::OnGetDlgCode() 
{
    return DLGC_WANTALLKEYS;
}

////////////////////////////////////////////////////////////////////////////
// CIDSInPlaceEdit overrides

// Stoopid win95 accelerator key problem workaround - Matt Weagle.
BOOL CIDSInPlaceEdit::PreTranslateMessage(MSG* pMsg) 
{
...
// Auto delete
void CIDSInPlaceEdit::PostNcDestroy() 
{
    CEdit::PostNcDestroy();
...
////////////////////////////////////////////////////////////////////////////
// CIDSInPlaceEdit implementation

void CIDSInPlaceEdit::EndEdit()
{
    CString str;
