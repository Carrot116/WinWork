...
class CIDSGridCellBase : public CObject
{
    friend class CIDSGridCtrl;
    DECLARE_DYNAMIC(CIDSGridCellBase)

// Construction/Destruction
public:
    CIDSGridCellBase();
    virtual ~CIDSGridCellBase();
...
public:
    ...
    virtual void SetGrid(CIDSGridCtrl* /* pGrid */)            = 0 ;
    ...
    virtual CIDSGridCtrl* GetGrid()       const                = 0 ;
    virtual CWnd     * GetEditWnd()    const                = 0 ;
    virtual UINT       GetMargin()     const                = 0 ;
	virtual UINT        GetVMargin() const					= 0;
    virtual CIDSGridCellBase* GetDefaultCell() const;
...
// Operators
public:
    virtual void operator=(const CIDSGridCellBase& cell);
