...
class CIDSMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CIDSMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CIDSMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CIDSMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CIDSMemDC
