...
class CIDSGridCell : public CIDSGridCellBase
{
    friend class CIDSGridCtrl;
    DECLARE_DYNCREATE(CIDSGridCell)

// Construction/Destruction
public:
    CIDSGridCell();
    virtual ~CIDSGridCell();

// Attributes
public:
    void operator=(const CIDSGridCell& cell);
    ...
    virtual void  SetGrid(CIDSGridCtrl* pGrid)      { m_pGrid = pGrid;     }                          
	...
	virtual void  SetFontEsay(int nFontHeight, LPCTSTR pszFontName = _T("ËÎÌå"), BOOL bBold = FALSE);
    virtual void  SetMargin(UINT nMargin)        { m_nMargin = nMargin; }
	virtual void  SetVMargin(UINT nMargin)        { m_nVMargin = nMargin; }
    ...
    virtual CIDSGridCtrl*  GetGrid() const             { return m_pGrid;   }
...
public:
    ...
    virtual DWORD    GetState() const                       { return CIDSGridCell::GetState()|GVIS_READONLY; }
...
extern tagFontInfo g_tFontInfo;
//{{AFX_INSERT_LOCATION}}
