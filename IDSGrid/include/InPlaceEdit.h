...
class CIDSInPlaceEdit : public CEdit
{
// Construction
public:
    CIDSInPlaceEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
// Implementation
public:
     virtual ~CIDSInPlaceEdit();
 
// Generated message map functions
protected:
    //{{AFX_MSG(CIDSInPlaceEdit)
