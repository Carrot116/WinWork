...
BEGIN_MESSAGE_MAP(CIDSTitleTip, CWnd)
	//{{AFX_MSG_MAP(CIDSTitleTip)
	ON_WM_MOUSEMOVE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CIDSTitleTip message handlers

BOOL CIDSTitleTip::Create(CWnd * pParentWnd)
{
...
BOOL CIDSTitleTip::DestroyWindow() 
{
    m_bCreated = FALSE;
...
void CIDSTitleTip::Show(CRect rectTitle, LPCTSTR lpszTitleText, int xoffset /*=0*/,
...
void CIDSTitleTip::OnMouseMove(UINT nFlags, CPoint point) 
{
...
BOOL CIDSTitleTip::PreTranslateMessage(MSG* pMsg) 
{
